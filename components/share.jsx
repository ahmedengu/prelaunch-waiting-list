        ...
        <div className="row align-items-center">
          ...
          <div className="col-12 ml-auto col-md-6 col-lg-5">
            ...
            <div>
              ...
              <a
                className="resp-sharing-button__link"
                href={`https://twitter.com/intent/tweet/?text=${encodeURIComponent(t('addthis-title'))}&amp;url=${shareLink}`}
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Twitter"
              >
              ...
              <a
                ...
                href={`https://www.linkedin.com/shareArticle?mini=true&amp;url=${shareLink}&amp;title=${encodeURIComponent(
                  t('addthis-title'))}&amp;summary=${encodeURIComponent(t('addthis-description'))}&amp;source=${shareLink}`}
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
              >
              ...
              <script
                ...
                src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5d8fc633026ccc05"
              />
            </div>
          </div>
        </div>
