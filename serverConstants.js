    ...
    multiLangConfirm: {
      ar: {
        ...
        body: {
          ...
          footer1: 'يتم الحصول علي الاسهم المالية المجانية بعد تفعيل الحسابات المشار اليها عن طريقك و بعد بدأ ميركوانت',
          footer2: 'إجراءات ترخيص وتسجيل ميركوانت لا تزال جارية.',
